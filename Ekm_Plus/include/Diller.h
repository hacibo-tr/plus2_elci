...
#define DIL_SAYISI            6         //Kaç tane dil ekliyse o sayı yazılacak. 
...
"DIL-LANGUAGE"        ,"LANGUAGE"            ,"JEZYK-LANGUAGE"      ,"JEZIK"               ,"GJUHA"               ,"SPRACHE",           //50
"TURKCE"              ,"ENGLISH"             ,"POLSKI"              ,"SRPSKI"              ,"SHQIP"               ,"DEUTSCH"             ,          //51
...
"BASINC SIFIR KAL."   ,"PRESSURE ZERO CAL."  ,"KALIBRA. CISNIENIA " ,"KAL.PRITISKA"        ,"SHTYPJA 0 KALIBR"    ,"DRUCK 0 KALIBRIERUNG",                          //72
"gr"                  ,"gr"                  ,"g"                   ,"gr"                  ,"gr"                  ,"gr",          //73
...
"YAZICI AYARI"        ,"PRINTER SETTING"     ,"UST. DRUKOWANIA"     ,"PODESAVANJE STAMPACA","CILESIMET E PRINT"   ,"DRUCKEREINSTELLUNGEN",              //169
